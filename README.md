...
The submitted Cloud Run deployment remains the attempt 1 baseline. The WDS four-screen redesign is verified locally against the authenticated reader connection and is waiting for laptop visual sign-off before deployment.
