...
- 합성 RFP fixture, 결정 엔진, inspectable policy trace, Streamlit workbench, in-session 작업 계획을 구현했습니다.
...
3. [제출 패키지](docs/SUBMISSION-PACKAGE_2026-08-01_v1.md)를 기준으로 영상을 녹화하고 대회 제출 필드를 확인합니다.
