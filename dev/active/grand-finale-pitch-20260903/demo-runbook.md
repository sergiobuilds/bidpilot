...
This runbook defines the 3 minute 15 second live path and its release-bound fallbacks.
...
|---:|---|---|
| 0:00–0:18 | Real-tender tab | Real public Suwon G2B source · technical 90 · price 10 |
| 0:18–0:33 | Source and supplier boundary | Source-reviewed facts · synthetic demo supplier profile |
| 0:33–0:55 | Decision boundary | Four evidence gaps · `REVIEW` · run 0 · proposal closed |
| 0:55–1:02 | Switch tabs | Separate synthetic historical replay |
| 1:02–1:30 | Replay verdict and score | `PURSUE` · 40/30/20/10 · 40-point priority |
| 1:30–1:52 | Win Position | Three compared · Proven Data Quality Operations selected |
| 1:52–2:25 | Weighted plan and proposal | Four plans · eight sections · evidence-bound content |
| 2:25–2:43 | Red-team | Persisted review result · score-bearing claims |
| 2:43–3:02 | Owned work | Twelve delivery, review, and provenance tasks |
| 3:02–3:15 | Snowflake proof and return | Same run ID · Cortex session · query provenance · no new run |
