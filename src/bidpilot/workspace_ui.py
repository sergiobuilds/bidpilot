...
def koat_dashboard(rows: Sequence[Mapping[str, object]], *, now: datetime) -> str:
    ...
    return (
        ...
        '<nav class="nav-links"><a class="nav-link active" href="?view=opportunities">Opportunities</a>'
        ...
        '<h1 class="t-headline1 w-bold phead-title">Official tender catalogue, by evidence level</h1>'
        '<p class="psub">One notice passed the source review; five were only found. Deadlines are judged against the clock below.</p></div>'
...
def koat_tender_detail(
    ...
    *,
    ...
    return (
        ...
        '<nav class="detail-nav"><a href="?view=opportunities">Dashboard</a><a class="current" href="#">Tender detail</a>'
        '<a href="?walkthrough=1">Verified replay</a></nav>'
        '</div></header><main class="detail-wrap"><nav class="crumb"><a href="?view=opportunities">‹ Opportunities</a>'
...
@media(max-width:480px){.bp-koat .nav-acct{display:none}.bp-koat .nav-link{padding:8px 6px;font-size:.8125rem;white-space:nowrap}.bp-koat .nav-in{gap:14px}.bp-koat .phead{align-items:stretch}.bp-koat .controls{width:100%;overflow-x:auto}.bp-koat .kpi-num{font-size:1.875rem}.bp-koat .frow{grid-template-columns:90px 1fr}.bp-koat .rts{display:none}.bp-koat .detail-nav a:first-child{display:none}}
