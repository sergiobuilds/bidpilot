...
def koat_dashboard(rows: Sequence[Mapping[str, object]]) -> str:
    ...
    return (
        ...
        '<section class="causal" aria-label="BidPilot workflow"><div class="causal-flow">'
        "<span><b>01</b>Public tender + supplier evidence</span>"
        "<span><b>02</b>Decision</span>"
        "<span><b>03</b>Score-weighted Win Position</span>"
        "<span><b>04</b>Proposal + red-team</span>"
        "<span><b>05</b>Owned work</span>"
        "<span><b>06</b>Same-run Snowflake replay</span></div>"
        '<nav class="tool-links" aria-label="Evaluator workspaces">'
        '<span class="tool-links-lab">Evaluator workspaces</span>'
        '<a href="?workspace=tender-intake">Tender intake</a>'
        '<a href="?workspace=bid-room">Authenticated Bid Room</a>'
        '<a href="?workspace=synthetic-simulation">Synthetic decision simulation</a>'
        "</nav></section>"
